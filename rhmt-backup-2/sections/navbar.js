  ...
  return new Promise((resolve, reject) => {
    ...
    if (navbar) {
      navbar.innerHTML = html`
        <div class="fixed w-full top-0 left-0 navbar z-[100]  ">
          <div class="container">
            <div
            ...
            >
              ...
              <div class="flex items-start">
                <div class="nav-links-drop-down none  max-lg:!hidden">
                  <button
                ...
                <div class="relative ">
                  ...
                  <button
                    id="dropdownToggle"
                    class="text-[18px] leading-[20px]  max-lg:block  dropdown-button dropdownButton proj"
                  >
                    <span>Projects</span>
                    <img
                      src="/assets/icons/chevron-down-icon.svg"
